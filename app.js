...
var addButton=document.querySelector(".task__btn");//first button
...
var createNewTaskElement=function(taskString){
    ...
    listItem.classList.add("section__task", "task");
    ...
    editButton.classList.add('task__btn', 'task__btn-edit');

    deleteButton.classList.add('task__btn', 'task__btn-delete');
...
var editTask=function(){
    ...
    editInput.classList.toggle("task__input-text_show");
    label.classList.toggle("task__name_hide")
};
...
var taskCompleted=function(){
    ...
    label.classList.toggle("task__name_completed");
